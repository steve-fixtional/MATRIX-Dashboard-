...
import { User, Palette, LayoutDashboard, Calendar, CloudRain, RefreshCw, Layers, ShieldCheck, Info, ChevronLeft } from 'lucide-react';
    ...
    <PageWrapper className="p-0">
      <div className="flex h-full w-full max-w-7xl mx-auto md:py-6">
        ...
        <div className={cn(
          ...
          <div className="p-4 md:p-6 md:pt-0 sticky top-0 bg-white/95 dark:bg-neutral-950/95 backdrop-blur-sm z-10">
        ...
        <div className={cn(
          ...
          {!isRootSettings && (
            <div className="md:hidden sticky top-0 z-10 flex items-center p-4 border-b border-neutral-200 dark:border-neutral-800 bg-white/95 dark:bg-neutral-950/95 backdrop-blur-sm">
              <NavLink to="/settings" className="flex items-center gap-2 text-sm font-medium text-neutral-600 dark:text-neutral-400">
